...
public class AlgoritmaGenetika {
    ...
    public AlgoritmaGenetika(Data data) {
        this.data = data;
    }
    ...
    Population crossoverPopulation(Population population) {
        ...
        IntStream.range(0, Driver.NUMB_OF_ELITE_SCHEDULES).forEach(x -> crossoverPopulation.getSchedule().set(x, population.getSchedule().get(x)));
